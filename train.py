...
if __name__ == '__main__':
    ...
    epochs_top = 1
    iterations_top = 2
    batch_size_top = 1024*2
    learning_rate_top = 1e-5
    epochs_all = 2
    iterations_all = 3
    batch_size_all = 1024*4
    ...
    data_train = load_file('data/traindata.txt')
    data_valid = load_file('data/validdata.txt')
    data_test = load_file('data/testdata.txt')
